...
function EmpresaLayout() {
    ...
    return (
        <>
            <nav className="navbar" id="main-nav">
                <div className="navbar-brand">
                    <span>EcoSincro - Empresa</span>
                </div>

                <div className="navbar-links">
                    <NavLink to="/empresa/residuos" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                        Mis Residuos
                    </NavLink>
                    <NavLink to="/empresa/receptores" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                        Buscar Receptor
                    </NavLink>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-4)' }}>
                    ...
                    <button
                        ...
                        title="Cambiar tema"
                        style={{
                            padding: 'var(--sp-2)', borderRadius: 'var(--r-md)', fontSize: '1rem',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                            color: 'var(--gray-500)', transition: 'all var(--ease-fast)',
                        }}
                    >
                        {theme === 'light' ? '🌙' : '☀️'}
                    </button>
                    <button className="btn-logout" onClick={() => { logout(); window.location.href = '/empresa/login'; }}>
                        Salir
                    </button>
                </div>
            </nav>
    ...
    return (
        <AuthProvider>
            <Routes>
                ...
                >
                    <Route index element={<Navigate to="residuos" replace />} />
